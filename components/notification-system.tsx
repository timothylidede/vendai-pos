        ...
        {isOpen && (
          <>
            ...
            >
              ...
              <div className="relative rounded-2xl backdrop-blur-xl bg-gradient-to-br from-white/[0.12] via-white/[0.08] to-white/[0.04] border border-white/[0.12] shadow-[0_20px_48px_-12px_rgba(0,0,0,0.4)] overflow-hidden">
                {/* Subtle background overlay to match brand */}
                <div className="absolute inset-0 bg-gradient-to-br from-blue-500/[0.03] via-transparent to-purple-500/[0.02]" />

                {/* Header */}
                <div className="relative p-4 border-b border-white/[0.12]">
              ...
              <div className="relative max-h-96 overflow-y-auto">
                {loading ? (
                  <div className="p-8 text-center">
                    <div className="w-6 h-6 border-2 border-white/30 border-t-blue-300 rounded-full animate-spin mx-auto mb-2"></div>
                    ...
                    {notifications.map((notification) => (
                      <div
                        ...
                        className={`relative p-4 hover:bg-white/5 transition-colors cursor-pointer ${
                          !notification.read ? 'bg-blue-400/5 before:absolute before:left-0 before:top-0 before:bottom-0 before:w-0.5 before:bg-blue-300/80' : ''
                        }`}
