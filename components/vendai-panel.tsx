  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 z-[9999] p-4 rounded-full bg-slate-800 shadow-2xl border-2 border-slate-600 hover:bg-slate-700 transition-all duration-200 transform hover:scale-110 active:scale-95 focus:outline-none ${isSpinning ? 'animate-spin-continuous' : ''}`}
