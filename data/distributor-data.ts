...
export const distributorProducts: Record<string, DistributorProduct[]> = {
  'sam-west': [
    { id: 'sw-1', code: '1', name: '10KG ABABIL PK 386 PARBOILED RICE', unitPrice: 1295, unit: 'Bag', inStock: true, leadTime: '1-2 days', category: 'Rice' },
    { id: 'sw-2', code: '2', name: '10KG AL-MAHAL BIRYANI RICE (Purple bag)', unitPrice: 1030, unit: 'Bag', inStock: true, leadTime: '1-2 days', category: 'Rice' },
    { id: 'sw-3', code: '3', name: '10KG CROWN PK 386 BASMATI RICE', unitPrice: 1235, unit: 'Bag', inStock: true, leadTime: '1-2 days', category: 'Rice' },
    { id: 'sw-4', code: '4', name: '10KG FALCON BRAND BIRYANI RICE (GREEN BAG)', unitPrice: 1070, unit: 'Bag', inStock: true, leadTime: '1-2 days', category: 'Rice' },
    { id: 'sw-5', code: '5', name: '10KG FZAMI 1121 LONG GRAIN RICE (Yellow bag)', unitPrice: 2150, unit: 'Bag', inStock: true, leadTime: '1-2 days', category: 'Rice' },
    { id: 'sw-6', code: '6', name: '10KG FZAMI BIRYANI RICE (WHITE BAG)', unitPrice: 1100, unit: 'Bag', inStock: true, leadTime: '1-2 days', category: 'Rice' },
    { id: 'sw-7', code: '7', name: '10KG FZAMI PK386 WHITE RICE (Black bag)', unitPrice: 1585, unit: 'Bag', inStock: true, leadTime: '1-2 days', category: 'Rice' },
    { id: 'sw-8', code: '8', name: '10KG FZAMI SUPERIOR LONG GRAIN RICE', unitPrice: 1120, unit: 'Bag', inStock: true, leadTime: '1-2 days', category: 'Rice' },
    { id: 'sw-9', code: '9', name: '10KG HIMALAYA FALCON PARBOILED RICE (YELLOW BAG)', unitPrice: 1740, unit: 'Bag', inStock: true, leadTime: '1-2 days', category: 'Rice' },
    { id: 'sw-10', code: '10', name: '10KG INDUS 1121 SELLA BASMATI RICE', unitPrice: 1815, unit: 'Bag', inStock: true, leadTime: '1-2 days', category: 'Rice' },
    { id: 'sw-11', code: '11', name: '10KG INDUS ECO BIRYANI RICE', unitPrice: 1030, unit: 'Bag', inStock: true, leadTime: '1-2 days', category: 'Rice' },
    { id: 'sw-12', code: '12', name: '10KG INDUS WHITE RICE', unitPrice: 1325, unit: 'Bag', inStock: true, leadTime: '1-2 days', category: 'Rice' },
    { id: 'sw-13', code: '13', name: '10KG JALAL BASMATI RICE', unitPrice: 1615, unit: 'Bag', inStock: true, leadTime: '1-2 days', category: 'Rice' },
    { id: 'sw-14', code: '14', name: '10KG KARIBU BASMATI (small bag) PARBOILED RICE', unitPrice: 1690, unit: 'Bag', inStock: true, leadTime: '1-2 days', category: 'Rice' },
    { id: 'sw-15', code: '15', name: '10KG KING AFRICA THAI RICE', unitPrice: 1020, unit: 'Bag', inStock: true, leadTime: '1-2 days', category: 'Rice' },
    { id: 'sw-16', code: '21', name: '20PCS NIP NAP WIPES', unitPrice: 5, unit: 'Packet', inStock: true, leadTime: '1-2 days', category: 'Personal Care' },
    { id: 'sw-17', code: '22', name: '210 ATTA MARK 1KG', unitPrice: 1800, unit: 'Bale', inStock: true, leadTime: '1-2 days', category: 'Flour' },
    { id: 'sw-18', code: '23', name: '210 ATTA MARK 2KG', unitPrice: 1770, unit: 'Bale', inStock: true, leadTime: '1-2 days', category: 'Flour' },
    { id: 'sw-19', code: '28', name: '25KG SUGAR (small bag)', unitPrice: 3600, unit: 'Bag', inStock: true, leadTime: '1-2 days', category: 'Sugar' },
    { id: 'sw-20', code: '30', name: '4U BATHING SOAP 144*15GM', unitPrice: 640, unit: 'Carton', inStock: true, leadTime: '1-2 days', category: 'Personal Care' },
  ],
  'mahitaji': [
